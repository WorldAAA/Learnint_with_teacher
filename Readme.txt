...
Ссылка на GitHub:
https://github.com/WorldAAA/Learnint_with_teacher

История изменений.
Ver.1 
Исходный файл проекта, без изменений
Ver.2
При обработке данных на ошибке, в столбце Tenure просто удаляем все строки с пропусками (в версии 1 мы распределяем отсутствующие значения на реальные случайным образом)
Ver.3
Исправлены ошибки в ссылках на исходный датасет (просмотрел в первых версиях), небольшие пунктуационные ошибки.
Ver.4
Убрана модель логистической регрессии, как самой неэффективной в проекте.
Ver.5
В данном файле и описании проекта в Jupiter Notebook добавлена ссылка на репозитарий в GitHub.